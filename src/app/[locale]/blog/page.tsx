    ...
    <>
      ...
      <main className="flex-grow">
        ...
        <section className="pt-32 pb-24 relative bg-primary-dark overflow-hidden min-h-[60vh] flex items-center bg-noise">
          ...
          <div className="absolute top-[20%] left-[15%] w-[500px] h-[500px] rounded-full bg-accent/5 blur-[200px] animate-pulse-glow" />
          <div className="absolute bottom-[10%] right-[10%] w-[400px] h-[400px] rounded-full bg-[#8B5CF6]/5 blur-[180px] animate-pulse-glow" />
