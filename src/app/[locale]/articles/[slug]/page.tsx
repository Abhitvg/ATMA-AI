import { getArticlePostBySlug } from "@/lib/mdx";
      ...
      <main className="flex-grow pt-32 pb-24 relative bg-primary-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row gap-12">
          <div className="flex-1 max-w-4xl">
            <Link
              href="/articles"
              className="inline-flex items-center gap-2 text-sm text-muted hover:text-[#F59E0B] transition-colors mb-8 font-mono"
            >
