        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://www.linkedin.com/in/abhisheksingh22141" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-lg bg-surface hover:bg-accent/10 text-muted hover:text-accent transition-all duration-300" aria-label="LinkedIn">
